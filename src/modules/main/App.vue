      ...
      <div class="develop-area">
        ...
        <div class="develop-item">
          ...
          <div class="develop-content">
            <p>神州数码智慧校园为您提供在线API测试工具，在您申请完API后，方可使用该工具。选择申请的接口，查看参数信息，输入参数向接口发起请求，通过返回值查看返回效果。</p>
        ...
        <div class="develop-item">
          ...
          <p class="develop-title">神州数码智慧校园PaaS</p>
          <div class="develop-content">
            <p>神州数码智慧校园PaaS平台为您提供丰富的开发资源和模板，包括测试资源申请、生产资源申请、环境配置、测试功能、上线功能、数据库功能、状态监控，以及代码托管、持续集成功能。</p>
