...
//创建骨架
    Class.pt.creat = function () {
        ...
        that.vessel(conType, function (html, titleHTML) {
            content && content.parent && content.parent().length && content.parent().length > 0 ? content.parent().append(html[0]) : $('body').append(html[0]);
            conType ? function () {
