    ...
    E.plugin(function () {
        ...
        fns.onload || (fns.onload = function (resultText, xhr) {
            ...
            if (resultText.indexOf('error|') === 0) {
                ...
                eval("resultObject="+resultText);
                // 将结果插入编辑器
                img = document.createElement('img');
                img.onload = function () {
                    var html = '<img src="'+getRootPath()+'/systemFileInfoAction/view?id= '+ resultObject[0].id + '" style="max-width:100%;"/>';
                ...
                img.src = getRootPath()+"/systemFileInfoAction/view?id="+resultObject[0].id ;
            }
