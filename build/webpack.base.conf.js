...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            template: 'src/ejs/index.ejs',
            inject: true,
            chunks: ["manifest", "vendor", "common", 'sources'],
            chunksSortMode: 'dependency'
        }),
        new HtmlWebpackPlugin({
            title: '充值缴费',
        ...
        new HtmlWebpackPlugin({
            title: '数据',
            filename: 'newThreeServices.html',
            template: 'src/ejs/newThreeServices.ejs',
            inject: true,
            chunks: ["manifest", "vendor", "common", 'newThreeServices'],
            chunksSortMode: 'dependency'
        })
    ],
    module: {
