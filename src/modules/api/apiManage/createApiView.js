...
var createApiView = Backbone.View.extend({
    ...
    initialize: function() {
        ...
        this.model.on('change:chargeType',function () {
            if((that.model.get('chargeType') == '01' || that.model.get('chargeType') == '04') && that.model.get('chargeSetJson')){
    ...
    buildChargeTable: function () {
        ...
        if(!chargeSetJson && (this.model.get('chargeType') == '01' || this.model.get('chargeType') == '04')){
            $('.api-package').hide();
        }
        else {
