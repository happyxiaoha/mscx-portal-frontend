<template>
  <div class="content grid-l">
    <c-filter type="service" :category="routeCategory" :tag="routeTag" v-on:updateParams="updateParams"></c-filter>
    <div class="app-list">
      ...
      <div class="app-list-result" v-loading="loading">
        <c-app-item v-for="item in appList" :itemObj="item" :key="item.id"></c-app-item>
