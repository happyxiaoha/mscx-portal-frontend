<template>
  <div>
    <div class="point-item">
      <h1>积分概况</h1>
      <hr>
      <p>积分余额：<span class="point-account">{{result.remainingPoint}}</span></p>
    </div>
    <div class="point-item">
      <h1>明细查询</h1>
      <hr>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getAllPointRecordList () {
        API.Point.getAllPointRecordList(this.params).then((res) => {
