  ...
  <div class="layout">
    ...
    <div class="content grid-l">
      ...
      <div class="content-block">
        ...
        <h1 class="desc-title">神州数云平台</h1>
        <div class="desc">聚合神州控股多年来在智慧城市领域积淀的能力，汇聚政府、 公共、市场大数据资源，形成以API、微应用为承载的资源服务能力，打通智慧城市大数据服务的供需对接，打 造以神州数云平台为核心的智慧城市新生态，助力神州控股成为整个大数据、API的服务商。
        </div>
      </div>
